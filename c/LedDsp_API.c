...
void LedDsp_Test(void)
{
   ...
   //////////////////////////////////////////////////////////////////////////////////////
    if(Key_Number!=0x00)
    {
		...
		switch(Key_Number)
		{
			case power_key:	test_key_data|=bit0;
                            break;
			case fan_key:	test_key_data|=bit1;
                            break;
			case down_key:	test_key_data|=bit2;
                            break;
			case up_key:	test_key_data|=bit3;
                            break;
			case timer_key:	test_key_data|=bit4;
                            break;
			case lamp_key:	test_key_data|=bit5;
                            break;
			case func_key:	test_key_data|=bit6;
                            break;
			case SWING_key:	test_key_data|=bit7;
                            break;
		}
		Key_Number=0;
    }
   ...
   {
	case  0x7f: test_seq=3;break;
	case  0xff: test_seq=2;break;
   }
  //////////////////////////////////////////////////////////////////////////////////////
}
