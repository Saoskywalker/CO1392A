...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "runytu9y8fnrmw8g"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//目标湿度(可下发可上报)
//备注:
#define DPID_DEHUMIDIFY_SET_VALUE 2
//模式(可下发可上报)
//备注:
#define DPID_MODE 5
//室内湿度(只上报)
//备注:
#define DPID_HUMIDITY_INDOOR 6
//童锁(可下发可上报)
//备注:
#define DPID_CHILD_LOCK 16
//故障告警(只上报)
//备注:E2:铜管sensor故障.
//E3:湿度Sensor故障.
//E5:MCU通讯故障.
#define DPID_FAULT 19
//水箱水位(只上报)
//备注:0.未满1.已满
#define DPID_TANK_FULL 101
//除霜状态(只上报)
//备注:0.未除霜1.除霜中
#define DPID_DEFROST_STATUS 102
